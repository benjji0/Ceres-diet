...
def selected_fruit_slider(fruit_name):
  prompt = "Number of " + fruit_name + " in the bowl: "
  num = st.slider(prompt, 0, 30, 2)
  return [fruit_name, num]

def App():  
  st.header('Build your own fruit bowl or smoothie!')
  st.text('Figure out how healthy your meal is with this easy tool.')
  ...
  # row 1
  cals.metric(label="Calories", value=total_cals, delta="1.2 °F")      
  sugar.metric(label="Sugar", value=total_sugar, delta="1.2 °F")        
  # row 2
  carbs.metric(label="Carbohydrates", value=total_carbs, delta="1.2 °F")    
  protine.metric(label="Protein", value=total_protine, delta="1.2 °F")
  # row 3
  fat.metric(label="Fat", value=total_fat, delta="1.2 °F")  
